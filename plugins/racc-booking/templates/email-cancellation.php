 ...
 *
 * Variables available: $client_name, $agent_name, $service_type,
 *                      $booking_date, $time_start, $time_end, $booking_id
 *
    ...
    <tr>
        <td style="padding:40px;">
            ...
            <p style="font-size:15px;color:#555;line-height:1.6;margin:0 0 25px;">
                <?php esc_html_e( 'We regret to inform you that your appointment has been cancelled. Below are the details of the cancelled booking:', 'racc-booking' ); ?>
            </p>
                    ...
                    <td style="padding:20px;">
                        <table width="100%" cellpadding="5" cellspacing="0">
                            <tr>
                                ...
                                <td style="color:#7f1d1d;font-size:14px;padding:8px 0;border-bottom:1px solid #fecaca;">#<?php echo esc_html( $booking_id ); ?></td>
                            </tr>
                            <tr>
                                <td style="color:#991b1b;font-size:13px;padding:8px 0;border-bottom:1px solid #fecaca;"><?php esc_html_e( 'Consultant', 'racc-booking' ); ?></td>
                                <td style="color:#7f1d1d;font-size:14px;padding:8px 0;border-bottom:1px solid #fecaca;"><?php echo esc_html( $agent_name ); ?></td>
                            </tr>
                            <tr>
            ...
            <p style="font-size:14px;color:#555;line-height:1.6;">
                <?php esc_html_e( 'If you would like to rebook an appointment, please visit our booking page or contact us directly.', 'racc-booking' ); ?>
            </p>
        </td>
    </tr>
